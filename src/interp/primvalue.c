...
{
    PrimitiveValue* pv = new_internal (PVM_PRIMTIVE_TYPE_INT8);
    pv->value.i8       = value;
    return pv;
}
...
{
    PrimitiveValue* pv = new_internal (PVM_PRIMTIVE_TYPE_INT16);
    pv->value.i16      = value;
    return pv;
}
...
{
    PrimitiveValue* pv = new_internal (PVM_PRIMTIVE_TYPE_INT32);
    pv->value.i32      = value;
    return pv;
}
...
{
    PrimitiveValue* pv = new_internal (PVM_PRIMTIVE_TYPE_INT64);
    pv->value.i64      = value;
    return pv;
}
...
{
    PrimitiveValue* pv = new_internal (PVM_PRIMTIVE_TYPE_UINT8);
    pv->value.u8       = value;
    return pv;
}
...
{
    PrimitiveValue* pv = new_internal (PVM_PRIMTIVE_TYPE_UINT16);
    pv->value.u16      = value;
    return pv;
}
...
{
    PrimitiveValue* pv = new_internal (PVM_PRIMTIVE_TYPE_UINT32);
    pv->value.u32      = value;
    return pv;
}
...
{
    PrimitiveValue* pv = new_internal (PVM_PRIMTIVE_TYPE_UINT64);
    pv->value.u64      = value;
    return pv;
}
...
{
    PrimitiveValue* pv = new_internal (PVM_PRIMTIVE_TYPE_FLOAT32);
    pv->value.f32      = value;
    return pv;
}
...
{
    PrimitiveValue* pv = new_internal (PVM_PRIMTIVE_TYPE_FLOAT64);
    pv->value.f64      = value;
    return pv;
}
...
{
    PrimitiveValue* pv = new_internal (PVM_PRIMTIVE_TYPE_BOOL);
    pv->value.b        = value;
    return pv;
}
...
{
    PrimitiveValue* pv = new_internal (PVM_PRIMTIVE_TYPE_CHAR);
    pv->value.c        = value;
    return pv;
}
