...
typedef enum
{
    ...
    STACK_EMULATOR_ITEM_TYPE_PRIMITIVE_FLOAT64,
    STACK_EMULATOR_ITEM_TYPE_PRIMITIVE_BOOL,
    STACK_EMULATOR_ITEM_TYPE_PRIMITIVE_CHAR,
